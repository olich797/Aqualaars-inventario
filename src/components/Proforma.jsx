...
const Proforma = () => {
  ...
  const [manualProduct, setManualProduct] = useState({ nombre: '', precio: 0, cantidad: 1 })
...
const generatePDF = (proforma) => {
  try {
    ...
    // === ENCABEZADO - AQUALAARS Y SUBTÍTULO JUNTOS ===
    doc.setFontSize(38)
  ...
  // 🗑️ Función para limpiar proforma
  const clearProforma = () => {
